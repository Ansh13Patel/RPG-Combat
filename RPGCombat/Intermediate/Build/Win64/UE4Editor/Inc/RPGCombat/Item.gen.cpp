...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AItem_Statics::NewProp_CollisionVolume_MetaData[] = {
		...
		{ "Comment", "/* Collision volume for coin to interact with player*/" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Item.h" },
		{ "ToolTip", "Collision volume for coin to interact with player" },
	};
#endif
	...
	IMPLEMENT_CLASS(AItem, 3809446328);
	template<> RPGCOMBAT_API UClass* StaticClass<AItem>()
	{
		return AItem::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AItem(Z_Construct_UClass_AItem, &AItem::StaticClass, TEXT("/Script/RPGCombat"), TEXT("AItem"), false, nullptr, nullptr, nullptr);
